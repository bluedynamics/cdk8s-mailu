...
**Information-oriented technical specifications and configurations for cdk8s-mailu.**

Reference guides provide detailed technical information about cdk8s-mailu's API, configuration options, and component specifications. They describe how things work and what parameters are available.

## API Reference

*This section will contain auto-generated or detailed documentation for:*
- `MailuChart` - Main chart class
- `MailuConfig` - Configuration interface
- Individual construct classes (AdminConstruct, FrontConstruct, etc.)
